...
This is a simple webpage that allows you to open videos/audios and use the transcription files (srt) to practice dictation with them. 
If you want to run it you only need to download the three files (html, css, js) and open it in a browser, I only tested in chrome but probably it works with other browsers too.
If you want to open youtube videos with the link, you need to selfhost the website with a server, if you don't do that you'll not be able to open youtube videos with the link, you'll only be able to open local videos/audios.

To use this tool you need to have the video/audio file and also the transcription files (it needs to be srt)
